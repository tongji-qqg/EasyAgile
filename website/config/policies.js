...
module.exports.policies = {
    ...
    "project": {
		...
		finishProject      : ["validateURLID", "checkUser", "validateProjectisAlive", "hasProjectOwner"],
		startProject       : ["validateURLID", "checkUser", "hasProjectOwner"],
    ...
    "static": {
        ...
        // Custom actions
        index            :["remember", true],
        mobile           :["remember", true],
		reg              :["remember", "flashMessage", "checkNotLogin"],
		login            :["remember", "flashMessage", "checkNotLogin"],
		userMain         :["remember", "validateURLID", "checkLogin"],
		userTask         :["remember", "validateURLID", "checkLogin"],
		userCal          :["remember", "validateURLID", "checkLogin"],
		userMessage      :["remember", "validateURLID", "checkLogin"],

		projectMain      :["remember", "validateURLID", "checkLogin", "hasProjectAccess"],
		projectTaskboard :["remember", "validateURLID", "checkLogin", "hasProjectAccess"],
		projectCal       :["remember", "validateURLID", "checkLogin", "hasProjectAccess"],
		projectIssue     :["remember", "validateURLID", "checkLogin", "hasProjectAccess"],
		projectFiles     :["remember", "validateURLID", "checkLogin", "hasProjectAccess"],
		projectTopic	 :["remember", "validateURLID", "checkLogin", "hasProjectAccess"],
		projectNewTopic	 :["remember", "validateURLID", "checkLogin", "hasProjectAccess"],
		projectOneTopic	 :["remember", "validateURLID", "checkLogin", "hasProjectAccess"],
		projectEditor    :["remember", "validateURLID", "checkLogin", "hasProjectAccess"],
		projectMembers   :["remember", "validateURLID", "checkLogin", "hasProjectAccess"],
		//projectHistory   :["remember", "validateURLID", "checkLogin", "hasProjectAccess"],		
    },
